...
var showWeather = function showWeather(id) {
  return $.ajax({
...
var showDay = function showDay(address, unixTime) {
  return $.ajax({
...
var viewRecent = function viewRecent() {
  return $.ajax({
    url: config.apiOrigin + '/locations',
    method: 'GET'
  });
...
var showForecast = __webpack_require__(17);
var showSearches = __webpack_require__(34);
var darkApi = __webpack_require__(4);
...
var getForecast = function getForecast() {
  ...
  for (var _i = 0; _i < 10; _i++) {
    var hourly = {
      time: convertedTime[_i],
      summary: store.weather.hourly.data[_i].summary,
      temp: roundedTemps[_i]
    };
  ...
  var showForecastHourly = showForecast({ locations: hourlyData });
  $('#hourly-forecast').html(showForecastHourly);
};

var onDaySuccess = function onDaySuccess(data) {
  store.location = data.location;
  var id = store.location.id;
  $('#city').html(store.location.address);
  darkApi.showWeather(id).then(onSuccess).catch(onFailure);
};
var onViewRecentSuccess = function onViewRecentSuccess(data) {
  $('#hourly-forecast').hide();
  $('#current-weather').hide();
  $('#recent-address').show();
  store.searches = data.locations;
  var num = store.searches.length;
  var searchArr = [];
  for (var i = num - 1; i > num - 11; i--) {
    searchArr.push({
      address: store.searches[i].address
    });
  }
  var showRecentSearches = showSearches({ locations: searchArr });
...
module.exports = {
  onSuccess: onSuccess,
  onDaySuccess: onDaySuccess,
  onViewRecentSuccess: onViewRecentSuccess,
  onFailure: onFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
var darkEvents = __webpack_require__(16);
var googleEvents = __webpack_require__(35);
...
var darkApi = __webpack_require__(4);
var darkUi = __webpack_require__(7);

var onGetWeather = function onGetWeather(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  var unixTime = new Date(data.time).getTime() / 1000;
  var address = data.address;
  darkApi.showDay(address, unixTime).then(darkUi.onDaySuccess).catch(darkUi.onFailure);
};
var onViewRecent = function onViewRecent(event) {
  event.preventDefault();
  darkApi.viewRecent().then(darkUi.onViewRecentSuccess).catch(darkUi.onFailure);
};
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<div class=\"col-lg-12\">\n  <div class=\"col hourly-info\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n    <div class=\"locationTime\" data-item-time=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.time : stack1), depth0))
    + "\">Time: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.time : stack1), depth0))
    + ":00</div>\n    <div class=\"locationTemp\" data-item-temp=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.temp : stack1), depth0))
    + "\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.temp : stack1), depth0))
    + "°F</div>\n    <div class=\"locationSummary\" data-item-summary=\""
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<div class=\"col-6 box-location\">\n  <div class=\"col-3\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n    <div class=\"locationAddress\" data-item-address=\""
...
var getFormFields = __webpack_require__(6);
var googleApi = __webpack_require__(36);
var googleUi = __webpack_require__(37);

var onSearchCity = function onSearchCity(event) {
  event.preventDefault();
  var city = getFormFields(event.target);
  var address = city.address;
  var unixTime = Math.round(new Date().getTime() / 1000);
  var time = unixTime.toString();
  googleApi.showCity(address, time).then(googleUi.onSuccess).catch(googleUi.onFailure);
};
...
var showCity = function showCity(address, time) {
  return $.ajax({
    url: config.apiOrigin + '/locations',
    method: 'POST',
    data: {
...
var onSuccess = function onSuccess(data) {
  ...
  $('#city').html(store.location.address);
  console.log(data);
  darkApi.showWeather(id).then(darkUi.onSuccess).catch(darkUi.onFailure);
};
